...
interface MissingRequestModalProps {
  open: boolean;
  onClose: () => void;
  returnData: {
    id: string;
...
export function MissingRequestModal({ open, onClose, returnData }: MissingRequestModalProps) {
  ...
  return (
    <Dialog open={open} onOpenChange={onClose}>
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        <DialogHeader>
          <DialogTitle>Missing Request - {returnData.id}</DialogTitle>
        </DialogHeader>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            <Label>Notes</Label>
            <Textarea
              placeholder="Enter notes about the missing items..."
              value={notes}
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button onClick={onClose}>Confirm Missing</Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
