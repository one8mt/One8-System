      ...
      <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
        ...
        <div className="space-y-6">
                    ...
                    <TableRow key={index}>
                      ...
                      <TableCell>
                        <Select defaultValue={item.replacementItem}>
                          ...
                          <SelectContent>
                            <SelectItem value="ITM-008 - Executive Desk">
                              ITM-008 - Executive Desk
                            </SelectItem>
                            <SelectItem value="ITM-010 - Metal Cabinet">
                              ITM-010 - Metal Cabinet
                            </SelectItem>
                            <SelectItem value="ITM-011 - Modern Desk">
                              ITM-011 - Modern Desk
                            </SelectItem>
                            <SelectItem value="ITM-012 - Wood Cabinet">
                              ITM-012 - Wood Cabinet
                            </SelectItem>
                          </SelectContent>
                        </Select>
                      </TableCell>
          ...
          <div className="flex justify-end gap-3">
            ...
            <Button onClick={onClose}>Approve Exchange</Button>
          </div>
        </div>
      </DialogContent>
    </Dialog>
